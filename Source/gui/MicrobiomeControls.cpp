...
void MicrobiomeControls::paint (juce::Graphics& g)
{
    ...
    controlTitle.setText(juce::String("Colony Controls: #") + juce::String(currentColony+1), juce::dontSendNotification);
...
int MicrobiomeControls::incrementColonyView()
{
    setViewToColony(currentColony+1);
    return currentColony;
}

int MicrobiomeControls::decrementColonyView()
{
    setViewToColony(currentColony-1);
    return currentColony;
}
